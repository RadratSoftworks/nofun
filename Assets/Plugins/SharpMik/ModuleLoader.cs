...
namespace SharpMik
{
	...
	public class ModuleLoader
	{
		...
		static public void BuildRegisteredModules()
		{
			...
			{
				s_RegistedModuleLoader.Add(typeof(Loaders._669Loader));
                s_RegistedModuleLoader.Add(typeof(Loaders.AMFLoader));
                s_RegistedModuleLoader.Add(typeof(Loaders.FARLoader));
                s_RegistedModuleLoader.Add(typeof(Loaders.ITLoader));
                s_RegistedModuleLoader.Add(typeof(Loaders.M15Loader));
                s_RegistedModuleLoader.Add(typeof(Loaders.MEDLoader));
                s_RegistedModuleLoader.Add(typeof(Loaders.ModLoader));
                s_RegistedModuleLoader.Add(typeof(Loaders.MTMLoader));
                s_RegistedModuleLoader.Add(typeof(Loaders.S3MLoader));
                s_RegistedModuleLoader.Add(typeof(Loaders.ULTLoader));
		...
		public static void RegisterModuleLoader<T>() where T: IModLoader
		{
